...
public class AnnotationViewManager implements ViewManager {
    ...
    private static final Logger logger = Logger
            .getLogger(AnnotationViewManager.class);

    public void forward(LogicRequest request, String result)
            throws ViewException {
        if (logger.isTraceEnabled())
            logger.trace("forward request to " + result);

        Method method = request.getLogicDefinition().getLogicMethod()
                .getMetadata();
    ...
    private Redirector getRedirector(String result,
            RedirectTo... redirectToArray) {
    ...
    public void directForward(LogicRequest arg0, String arg1, String arg2)
            throws ViewException {
