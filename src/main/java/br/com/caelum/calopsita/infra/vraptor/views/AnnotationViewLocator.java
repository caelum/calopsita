...
public class AnnotationViewLocator implements ViewLocator {
	...
	private static final Logger logger = Logger.getLogger(AnnotationViewLocator.class);
	private static final AnnotationViewManager ANNOTATION_VIEW_MANAGER = new AnnotationViewManager();

	@Override
	public ViewManager locate(VRaptorServletRequest arg0, LogicMethod arg1, ViewManager arg2)
			throws InvalidURLException, LogicException {
